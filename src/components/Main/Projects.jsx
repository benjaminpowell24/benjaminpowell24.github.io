  ...
  return (
    <section id="projects" className="my-10">
      ...
      <div className="grid lg:grid-cols-2 gap-3">
        <div className="border border-[#0000001A] dark:border-[#3c454d] rounded p-4">
          ...
          <p className="text-[#4A5568] dark:text-white">
            OpenAI powered conversational agent that operates as a helpful
            assistant
          </p>
          <div className="flex flex-wrap gap-2 my-2">
            {smartAssistantTags.map((tag) => (
              <span className="rounded-full bg-[#0000001A] dark:bg-sky-500 px-2 py-1 text-xs">
                {tag}
              </span>
            ))}
          </div>
